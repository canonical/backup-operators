.. meta::
   :description: Familiarize yourself with contributing to the Backup charm documentation.
...
.. note::
   ...
   See `CONTRIBUTING.md <https://github.com/canonical/backup-operators/blob/main/CONTRIBUTING.md>`_
   for information on contributing to the source code. 

Our documentation is hosted on `Read the Docs <https://documentation.ubuntu.com/backup-operators>`_ to enable collaboration.
...
`source code on GitHub <https://github.com/canonical/backup-operators>`_.
